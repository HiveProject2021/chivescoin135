...
from chives.util.config import lock_and_load_config, save_config
...
from chives.wallet.transaction_sorting import SortKey
from chives.wallet.util.compute_memos import compute_memos
...
class TestWalletRpc:
    ...
    async def test_wallet_rpc(self, two_wallet_nodes, trusted, bt, self_hostname):
        ...
        try:
            ...
            # Creates a Token Wallet with 100 mojos and a CAT with 20 mojos
            ...
            # Create an offer of 5 chives for one CAT
