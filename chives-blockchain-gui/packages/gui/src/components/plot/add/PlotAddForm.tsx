...
import { defaultPlotter } from '@chives/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@chives/api-react';
import { useForm, SubmitHandler } from 'react-hook-form';
import { Back, useShowError, ButtonLoading, Flex, Form, toBech32m } from '@chives/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.CHIVESPOS),
  });
