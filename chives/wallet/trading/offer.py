...
from chives.util.bech32m import bech32_encode, bech32_decode, convertbits
from chives.util.ints import uint64
from chives.wallet.util.puzzle_compression import (
...
class Offer:
    ...
    def notarize_payments(
        requested_payments: Dict[Optional[bytes32], List[Payment]],  # `None` means you are requesting XCC
        coins: List[Coin],
