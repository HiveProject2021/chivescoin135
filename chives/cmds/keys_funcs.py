...
def show_all_keys(show_mnemonic: bool, non_observer_derivation: bool):
    ...
    for sk, seed in private_keys:
        ...
        print(f"=======================:{non_observer_derivation}")
...
def derive_sk_from_hd_path(master_sk: PrivateKey, hd_path_root: str) -> Tuple[PrivateKey, str]:
    ...
    from chives.wallet.derive_keys import _derive_path, _derive_path_unhardened
...
def _search_derived(
    ...
    for index in range(limit):
        ...
        if search_address:
            ...
            address = encode_puzzle_hash(create_puzzlehash_for_pk(child_pk), "xcc")
